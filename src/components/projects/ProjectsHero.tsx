        ...
        <ScrollReveal>
          <div style={{ display: "flex", flexDirection: "column", gap: "20px", maxWidth: "750px" }}>
            ...
            <p style={{ fontSize: "18px", fontWeight: 400, lineHeight: "25.2px", color: "#595959" }}>
              At Compose, we&apos;re passionate about transforming brands through impactful digital strategies. Our work spans across industries, each project uniquely crafted to reflect our client&apos;s vision and achieve measurable results. Take a look at some of our proudest projects and see how we turn ideas into impactful experiences.
            </p>
          </div>
        </ScrollReveal>
